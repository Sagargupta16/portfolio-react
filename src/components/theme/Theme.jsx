...
const Theme = () => {
    ...
    () => [
      {
        ...
        colors: {
          ...
          'bg-variant': '#2c2c6c',
          primary: '#4db5ff',
          'primary-variant': 'rgba(77, 181, 255, 0.5)'
        }
      },
      {
        name: 'theme2',
        colors: {
          ...
          'bg-variant': '#404255',
          primary: '#00ccff',
          'primary-variant': 'rgba(0, 204, 255, 0.5)'
        }
      },
      {
        name: 'theme3',
        colors: {
          ...
          'bg-variant': '#393e46',
          primary: '#00adb5',
          'primary-variant': 'rgba(0, 173, 181, 0.5)'
        }
      },
      {
        name: 'theme4',
        colors: {
          ...
          'primary-variant': 'rgba(130, 170, 227, 0.5)'
        }
      },
      {
        name: 'theme5',
        colors: {
          ...
          'bg-variant': '#2f3654',
          primary: '#ffaf3e',
          'primary-variant': 'rgba(255, 175, 62, 0.5)'
        }
      },
      {
        name: 'theme6',
        colors: {
          ...
          'bg-variant': '#2a3a4f',
          primary: '#ef5350',
          'primary-variant': 'rgba(239, 83, 80, 0.5)'
        }
      },
      {
        name: 'theme7',
        colors: {
          ...
          'bg-variant': '#2f4c6e',
          primary: '#4caf50',
          'primary-variant': 'rgba(76, 175, 80, 0.5)'
        }
      },
      {
        name: 'theme8',
        colors: {
          ...
          'bg-variant': '#2f415f',
          primary: '#ff7043',
          'primary-variant': 'rgba(255, 112, 67, 0.5)'
        }
      },
      {
        name: 'theme9',
        colors: {
          ...
          'bg-variant': '#3e4450',
          primary: '#ff6666',
          'primary-variant': 'rgba(255, 102, 102, 0.5)'
        }
      },
      {
        name: 'theme10',
  ...
  useEffect(() => {
    ...
    // Set the body class to the current theme name
    body.className = currentTheme.name
