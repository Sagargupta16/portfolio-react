...
export const GradientSweep = ({ progress }: ProgressProps) => {
...
export const GlowPulse = ({ progress }: ProgressProps) => {
...
export const GeometricScatter = ({ progress }: ProgressProps) => {
   const opacity = useTransform(progress, [0, 0.3, 0.7, 1], [0, 1, 1, 0]);
...
export const Beam = ({ progress }: ProgressProps) => {
