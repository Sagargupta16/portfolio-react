...
const getMedalColor = (title: string): string => {
...
const Achievement = () => {
   ...
   const isNumericStat = (value: unknown): boolean => /^\d/.test(String(value));
            ...
            {learningBadges.length > 0 && (
               <div>
                  ...
                  >
                     ...
                     >
                        <BookOpen
                           style={{ width: 18, height: 18, color: "#a855f7" }}
                        />
                     </div>
               ...
               <div>
                  ...
                  >
                     {platformEntries.map(([platform, stats]) => {
                        const platformStats = stats as Record<string, unknown>;
                        return (
                           <motion.div
                              key={platform}
                              className="glass-card"
                           ...
                           >
                              ...
                              >
                                 {(
                                    (platformStats.displayStats as string[]) ||
                              ...
                              {(platformStats.profileUrl as
                                 | string
                                 | undefined) && (
                                 <a
                                    href={platformStats.profileUrl as string}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    style={{
                                       display: "inline-flex",
