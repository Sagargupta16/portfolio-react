...
const Achievement = () => {
  ...
  return (
    <motion.section id="achievement" className="section achievement-section" initial="hidden" animate="visible">
      <motion.div className="container achievement__container" variants={staggerContainer}>
