...
const GitHubIcon = ({ style }: IconStyleProps) => (
   <svg viewBox="0 0 24 24" fill="currentColor" style={style}>
...
const getContactMeta = (title: string): ContactMeta => {
